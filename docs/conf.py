...
latex_documents = [
  ('index', 'argus.tex', 'argus Documentation',
...
man_pages = [
    ('index', 'argus', 'argus Documentation',
     ['Cloudbase Solutions'], 1)
]
...
texinfo_documents = [
  ('index', 'argus', 'argus Documentation',
   'Cloudbase Solutions', 'argus', 'One line description of project.',
   'Miscellaneous'),
]
...
autodoc_mock_imports = ['tempest', 'tempest.common',
                        'oslo', 'oslo.utils',
